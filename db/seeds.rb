...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/watermelon.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/coffee.jpeg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/coca_cola.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/sprite.jpeg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/fanta.jpg').to_s),
                         filename: 'fanta.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/sweet.jpg').to_s),
                         filename: 'sweet.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/cheese.jpg').to_s),
                         filename: 'cheese.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/pretzel.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/wings.jpg').to_s),
                         filename: 'wings.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/buffalo.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/zucchini.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/tomato.jpg').to_s),
                         filename: 'tomato.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/beetroot.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/salmon.jpg').to_s),
                         filename: 'salmon.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/chicken.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/scallops.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/pizza.jpg').to_s),
                         filename: 'pizza.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/burger.jpg').to_s),
                         filename: 'burger.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/mac.jpg').to_s),
                         filename: 'mac.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/biscuit.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/coleslaw.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/danish.jpg').to_s),
                         filename: 'danish.jpg',
                         content_type: 'image/jpg')
item.save
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/icecream.jpg').to_s),
...
item.item_picture.attach(io: File.open(Rails.root.join('app/assets/images/lasagna.jpg').to_s),
